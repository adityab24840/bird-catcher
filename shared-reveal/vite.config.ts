...
export default defineConfig(({ mode }) => {
  // loadEnv reads .env, .env.local, .env.[mode], etc. — the '' prefix loads all vars.
  // This makes VITE_* vars available to the define block (process.env alone won't have them).
